    ...
    <footer className="bg-navy text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-start">
          ...
          <div>
            <Link to="/">
              <img src={logo} alt="Bend Performance Lab" className="h-16 w-auto mb-4" />
            </Link>
          ...
          <div>
            ...
            <div className="space-y-2 text-sm text-white/60">
              ...
              <a
                ...
                className="inline-flex items-center gap-2 hover:text-white transition-colors mt-2"
              >
        ...
        <div className="border-t border-white/10 mt-10 pt-6 text-center text-sm text-white/40">
          &copy; {new Date().getFullYear()} Bend Performance Lab. All rights reserved.
        </div>
      </div>
    </footer>
  )

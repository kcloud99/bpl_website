...
import facilityRender from '../assets/facility_new.PNG'
import weightRoom from '../assets/weight_room_new.PNG'
          ...
          <FadeInSection>
            <div className="max-w-3xl mx-auto text-center mb-16">
              ...
              <p className="text-lg text-white/70 leading-relaxed">
                Bend Performance Lab is a 20k+ sq ft purpose-built indoor training facility in east Bend, designed specifically for baseball and softball athletes. Year-round access to training environments built around how diamond athletes actually develop.
              </p>
            </div>
          </FadeInSection>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5 mb-14">
            {[
              ...
              { feature: "80' x 100' convertible turf infield", desc: 'Full infield surface for ground balls, team drills, and defensive reps.', icon: <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M9 4.5v15m6-15v15m-10.875 0h15.75c.621 0 1.125-.504 1.125-1.125V5.625c0-.621-.504-1.125-1.125-1.125H4.125C3.504 4.5 3 5.004 3 5.625v12.75c0 .621.504 1.125 1.125 1.125z" /> },
              ...
              { feature: '1,500 sq ft athlete-specific weight room', desc: 'Sport-specific strength equipment built for rotational athletes.', icon: <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M3.75 13.5l10.5-11.25L12 10.5h8.25L9.75 21.75 12 13.5H3.75z" /> },
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-6 max-w-3xl mx-auto mb-14">
            {[
              ...
              { stat: '350+', label: 'Athletes on Waitlists' },
            ].map((item, i) => (

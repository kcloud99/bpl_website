      ...
      <section className="bg-gradient-to-b from-gray-bg to-white py-24 sm:py-32 relative">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl mx-auto">
            {[
              {
                quote: "We've essentially given up trying to book time at the Fieldhouse. Between the scheduling difficulties and baseball getting priority at Mountain View, our softball teams just don't have reliable indoor access during the winter months.",
                name: 'Kayleen',
